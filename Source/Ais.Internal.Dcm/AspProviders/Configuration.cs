    ...
    internal static class Configuration
    {
        ...
        internal static CloudStorageAccount GetStorageAccount(string settingName)
        {
            try
            {
                ...
                var accountName = (string)rdr.GetValue("MetadataStorageAccountName", typeof(string));
                var key = (string)rdr.GetValue("MetadataStorageKey", typeof(string));
                //return new CloudStorageAccount(new StorageCredentialsAccountAndKey("storageaismediaservice3", "kATzafnzs0bG3CzAw0FnYv6Cgs4uV4qjXMuT88OmLq5C2FZ2t5G9J57MvhPwAfQI+e0U+hVK+xx7XTut1gGgbQ=="), true);
                return new CloudStorageAccount(new StorageCredentialsAccountAndKey(accountName, key), true);
